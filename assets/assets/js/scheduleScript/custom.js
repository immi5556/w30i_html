...
$(function(){
  ...
  var regisurl = "https://registration.within30.com/";         //"https://registration.schejule.com:9090/"
  ...
  function clickFn(arr,divElem){
    ...
    dates.each(function(i, item){
            ...
            }else if(divElem == '.weekSec' && !holidayArry[i] && firstEntry == -1){
...
var setDates = function(){
    ...
    if(firstWorkingDay != 0){
        ...
        setData(daysOrder[0],thisDate, 0);
    }
